...
<textarea type="article_content" name="article_content" id="article_content" autocomplete="article_content"><?php if (isset($article_content)) {echo $article_content;} ?></textarea><br>
